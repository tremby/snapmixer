...
- `m`: toggle mute
- `s`/`S`: cycle stream forward/backward for the active group
- `q`/`Esc`/`^C`: quit
...
- Option to show volumes on a log scale rather than linear([#15](https://github.com/tremby/snapmixer/issues/15))
